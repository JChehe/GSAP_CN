...
再次声明，CSSPlugin 是特殊案例，TweenLite（1.8.0 版本起）无需将 CSS 相关的属性包装在 css 对象内（虽然可获得最佳性能）。
...
* 若觉得本平台有用，请考虑加入 Club GreenSock。这不仅有助于平台的持续发展，还可以获得会员专属的插件、课程和其它福利。可通过 [http://greensock.com/club/](http://greensock.com/club/) 了解更多信息。
